...
import com.jayvaghela.otakucommunitytub.Activity.MessageActivity;
...
public class SearchRecyclerAdapter extends RecyclerView.Adapter<SearchRecyclerAdapter.ViewHolder> {
    ...
    public SearchRecyclerAdapter(Context mContext, OnItemClick onItemClick, List<Users> mUsers, boolean ischat){
